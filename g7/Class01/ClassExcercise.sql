--in this example you will find Primary key constraint
--as we mentioned on the class and
--regarding that, we will go more in depth on the next class

USE [master]
GO

DROP DATABASE IF EXISTS [QINSHIFT]
GO

CREATE DATABASE [QINSHIFT]
GO
